...
class AddTravelStyle : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvSkip.setOnClickListener {
            val travel = TravelData("", sName, sPlace, sDate, eDate, diffDay, sTravelWhom, sTravelStyle, 0)
        ...
        binding.applyDate.setOnClickListener {
            val travel = TravelData("", sName, sPlace, sDate, eDate, diffDay, sTravelWhom, sTravelStyle)
